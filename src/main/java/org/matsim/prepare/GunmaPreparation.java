...
/**
 * Preparation-only entry point for the Gunma scenario generation pipeline.
 */
...
public class GunmaPreparation extends MATSimApplication {
	...
	/**
	 * Creates the preparation command rooted in the canonical Gunma config file.
	 */
	...
	/**
	 * Runs the preparation command from the command line.
	 *
