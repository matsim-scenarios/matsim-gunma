...
@CommandLine.Command(header = ":: Open Gunma Preparation ::", mixinStandardHelpOptions = true)
...
public class OpenGunmaPreparation extends MATSimApplication {

	public OpenGunmaPreparation() {
		super(ConfigUtils.loadConfig(OpenGunmaDefaults.configPath()));
	}

	public static void main(String[] args) {
		MATSimApplication.run(OpenGunmaPreparation.class, args);
	}
}
