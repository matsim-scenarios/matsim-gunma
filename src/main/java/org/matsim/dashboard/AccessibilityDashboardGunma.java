 ...
 */
public class AccessibilityDashboardGunma implements Dashboard {
...
//	private final boolean equity = true;
	...
	private void accessibilityDataGridMap(String modeName, String columnName, String poi, GridMap viz, Data data) {
		...
		viz.file = data.computeWithPlaceholder(PrepareAccessibilityForSimWrapperConverterGunma.class, "%s/accessibilities_simwrapper.csv", poi);
